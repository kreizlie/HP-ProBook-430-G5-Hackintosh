...
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "8377    ", 0x00000000)
{
    ...
    OperationRegion (HPMA, SystemMemory, 0x83F6C000, 0x00000060)
    ...
    OperationRegion (HPGF, SystemMemory, 0x83F78000, 0x00000257)
    ...
    OperationRegion (HPTR, SystemMemory, 0x83F7A000, 0x00000018)
    ...
    OperationRegion (HPCD, SystemMemory, 0x83F7B000, 0x000000F3)
    ...
    OperationRegion (HPWM, SystemMemory, 0x83F73000, 0x00002818)
    ...
    Device (_SB.WMIB)
    {
        ...
        OperationRegion (HWSS, SystemMemory, 0x83F70000, 0x00000802)
    ...
    OperationRegion (HPWV, SystemMemory, 0x83F71000, 0x0000107C)
    ...
    OperationRegion (HPCF, SystemMemory, 0x83F7C000, 0x00000055)
    ...
    OperationRegion (HPIL, SystemMemory, 0x83F79000, 0x00000001)
