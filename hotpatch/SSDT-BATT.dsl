...
DefinitionBlock("", "SSDT", 2, "ACDT", "BATT", 0)
{
    ...
    External (_SB.PCI0.LPCB.EC.GBTX, MethodObj)
    External (_SB.PCI0.LPCB.EC.SBTX, MethodObj)
    External (_SB.PCI0.LPCB.EC.XACW, MethodObj)
    External (_SB.PCI0.LPCB.EC.XBAW, MethodObj)
    External (_SB.PCI0.LPCB.EC.NBTX, PkgObj)
    ...
    Scope(_SB.PCI0.LPCB.EC)
    {
            ...
            If (_OSI ("Darwin"))
            {
                ...
                If (ECRG)
                {
                    If (And (BATP, ShiftLeft (One, Arg0)))
                    {
                        ...
                        Store (GBSS (B1B2 (SN00, SN01), B1B2 (AT00, AT01)), BTSN)
                        Store (GBMF (), Local1)
        ...
        Method (SBTC, 3, NotSerialized)
        {
            ...
            Else
            {
                Return (\_SB.PCI0.LPCB.EC.SBTX (Arg0, Arg1, Arg2))
            }
        }
